                        ...
                        <div className="row">
                            ...
                            <div className="doctor-appointmentmenus">
                                    ...
                                    <Link to="/PastAppointments"
                                        style={{ background: "linear-gradient(to left, #2daab8 0%, #16bbe5 100%)", color: "#fff", fontWeight: 500, padding: "16px", borderRadius: "8px", textDecoration: "none", display: "inline-block", }}><i className="fa-solid fa-wand-magic-sparkles"></i> Past Appointments</Link><br /><br />
